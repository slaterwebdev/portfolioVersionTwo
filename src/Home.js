    ...
    return ( 
        <div className="home d-flex justify-content-center align-center mt-2">
            <div className="w-40 ">
                ...
                <p className="font-md mb-4 font-karla">
                    
                    I'm a rapidly growing Dev looking for my next opportunity. My strengths lie within <span>REACT</span> and <span>JAVASCRIPT</span>, two technologies that I have an indepth knowledge of. I use these to help bring answers and results to the table. Which in turn reduces the number of questions and problems. Take a look around the site and feel free to get in touch.
