...
const PersonalProjectsOne = (props) => {
    ...
    return ( 
        <div className="d-flex flex-wrap justify-center mt-3 pos-relative">
            ...
            <Card cardCode={cardCode[1]} cardTitle={cardTitle[1]} cardText={cardText[1]} cardImg={cardImg[1]} cardBtnHref={cardBtnHref[2]} cardBackground={cardBackground[1]} />
            <Card cardCode={cardCode[2]} cardTitle={cardTitle[2]} cardText={cardText[2]} cardImg={cardImg[2]} cardBtnHref={cardBtnHref[1]} cardBackground={cardBackground[2]} />
        </div>
    );
}
